...
/* Configurations of the DC Motor [ For External Hardware H-Bridge ] */

#define MOTOR_H_PORT      		DIO_u8_PORTB
#define MOTOR_TR1_CW_PIN        DIO_u8_PIN4
#define MOTOR_TR2_CW_PIN        DIO_u8_PIN5

#define MOTOR_H_PORT      		DIO_u8_PORTB
#define MOTOR_TR1_CCW_PIN       DIO_u8_PIN6
#define MOTOR_TR2_CCW_PIN       DIO_u8_PIN7
